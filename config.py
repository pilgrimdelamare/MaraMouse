...
# Echo cancellation: un secondo Vosk gira sul loopback. Se anche il loopback
# riconosce la wake word, il trigger viene rifiutato (era la TV).
# Nessuna soglia da tarare: stesso riconoscitore su entrambi i segnali.
